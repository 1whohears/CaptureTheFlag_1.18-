...
title @s actionbar ["",{"text":"∆x=","color":"blue"},{"score":{"name":"math","objective":"x"},"color":"blue"},{"text":",∆y=","color":"blue"},{"score":{"name":"math","objective":"y"},"color":"blue"},{"selector":",∆z=","color":"blue"},{"score":{"name":"math","objective":"z"},"color":"blue"}]
